...
function myFunction(xml, j, id_counter) {
  ...
  for (i = 0; i <x_all.length; i++) {
    ...
    if(id_of_item == x_all[i].childNodes[5].childNodes[0].nodeValue){


      // console.log(id_of_item + "==" + x_all[i].childNodes[3].childNodes[0].nodeValue);
      job_name = x_all[i].childNodes[1].childNodes[0].nodeValue;
      company_name =  x_all[i].childNodes[3].childNodes[0].nodeValue;
